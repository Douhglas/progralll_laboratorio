...
import cr.ac.una.gmailapp.controllers.Controller;
...
public class FlowController {
    ...
    public void goMain() {
        try {
            this.mainStage.setScene(new Scene(FXMLLoader.load(App.class.getResource("views/gmailMenu.fxml"), this.idioma)));
