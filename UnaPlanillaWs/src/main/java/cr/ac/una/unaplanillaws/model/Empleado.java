...
@NamedQueries({
    ...
    @NamedQuery(name = "Empleado.findByCedulaNombrePapellido", query = "SELECT e FROM Empleado e WHERE UPPER(e.nombre) like :nombre and UPPER(e.cedula) like :cedula and UPPER(e.primerApellido) like :pApellido and UPPER(e.segundoApellido) like :sApellido", hints = @QueryHint(name = "eclipselink.refresh", value = "true")),
